...
<summary><a href="who-are-these-docs-for.md#user-guide-template-for-dexes"><strong>User Guide Template for DEXes</strong></a></summary>

A ready-to-adapt guide for **DEX Teams** to provide users with a clear understanding of how to interact with Algebra-powered platforms.
...
<summary><strong>Builder SDKs &#x26; Tooling</strong></summary>

A practical toolkit for **development teams** with SDKs, APIs, and helper libraries to support frontend and backend development, simulation, and testing on both CLAMM and Integral setups.
