...
Creates a new pool if it does not exist, then initializes if not initialized _Developer note: This method can be bundled with others via IMulticall for the first action (e.g. mint) performed against a pool_
