...
_Developer note: farms\[tokenId]\[incentiveHash] => Farm_

### uint256 numOfIncentives

### bytes32 INCENTIVE\_MAKER\_ROLE constant

### bytes32 FARMINGS\_ADMINISTRATOR\_ROLE constant
...
Check if incentive is active in Algebra pool _Developer note: Does not check that the pool is indeed an Algebra pool_
