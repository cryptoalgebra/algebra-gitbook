...
_Developer note: The address of the farming center contract, which handles farmings logic_

### mapping(uint256 => address) farmingApprovals

_Developer note: mapping tokenId => farmingCenter_

### mapping(uint256 => address) tokenFarmedIn

_Developer note: mapping tokenId => farmingCenter_

### bytes32 NONFUNGIBLE\_POSITION\_MANAGER\_ADMINISTRATOR\_ROLE constant
