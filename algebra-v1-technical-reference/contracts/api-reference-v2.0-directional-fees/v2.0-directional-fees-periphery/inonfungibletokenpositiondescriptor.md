...
Produces the URI describing a particular token ID for a position manager _Developer note: Note this URI may be a data: URI with the JSON contents directly inlined_
