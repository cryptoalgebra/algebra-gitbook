...
Get the parameters to be used in constructing the pool, set transiently during pool creation. _Developer note: Called by the pool constructor to fetch the parameters of the pool_
...
_Developer note: Deploys a pool with the given parameters by transiently setting the parameters in cache._
