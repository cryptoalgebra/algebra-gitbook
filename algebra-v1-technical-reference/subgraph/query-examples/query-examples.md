...
* [collected fees for a position](/broken/pages/ufpDZ3Dheb1wxtEz4C3k)
* [current liquidity](/broken/pages/ufpDZ3Dheb1wxtEz4C3k) of a pool
* [volume on a certain day](/broken/pages/ufpDZ3Dheb1wxtEz4C3k)
...
```
{
  factory(id: "0x8c1eb1e5325049b412b7e71337116bef88a29b3a" ) {
    poolCount
    txCount
    totalVolumeUSD
    totalVolumeMatic
...
```
{
  factory(id: "0x8c1eb1e5325049b412b7e71337116bef88a29b3a", block: {number: 22529988}){
    poolCount
    txCount
    totalVolumeUSD
    totalVolumeMatic
...
To get data about a certain pool, pass in the pool address. Reference the full [pool schema](/broken/pages/ufpDZ3Dheb1wxtEz4C3k) and adjust the query fields to retrieve the data points you want.
...
This query returns daily aggregated data for the first 10 days since the given timestamp for the ALGB-USDC pool.
...
To query data about a particular swap, input the transaction hash + "#" + the index in the swaps the transaction array. This is the reference for the full [swap schema](/broken/pages/ufpDZ3Dheb1wxtEz4C3k).
...
This queries the decimals, symbol, name, pool count, and volume in USD for the ALGB token. Reference the full [token schema](/broken/pages/ufpDZ3Dheb1wxtEz4C3k) for all possible fields you can query.
...
To get data about a specific position, input the NFT tokenId. This queries the collected fees for token0 and token1 and current liquidity for the position with tokedId 3. Reference the full [position schema](/broken/pages/ufpDZ3Dheb1wxtEz4C3k) to see all fields.
...
"Data accumulated and condensed into day stats for each exchange” "Note: this entity gets saved only if there is a change during the day”
