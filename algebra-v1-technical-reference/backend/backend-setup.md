...
1. set BACKEND\_SETTINGS\_MODE to `production`
2. set HTTP\_TEMPLATE\_DIR to `/etc/nginx/templates/ssl`
...
**All the amounts are displayed as&#x20;**_**MATIC**_**&#x20;but are not converted into Matic exactly. This is just a name to the native tokens (since we deployed to the Polygon)**
